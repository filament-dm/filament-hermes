...
def register(ctx: Any) -> None:
    ...
    ctx.register_platform(
        ...
        platform_hint=(
            ...
            "as an '[attachment: ...]' note with the filename and type. You "
            "cannot view or download the media content itself yet — if "
            "asked about an attachment, be honest that you can only see "
            "its metadata.\n"
            "SENDING MESSAGES:\n"
